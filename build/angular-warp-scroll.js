...
app.directive('dots', function () {
    ...
    .factory('scrollService', ["$window", "$document", function ($window, $document) {
        return {
            /**
             * Current scroll progress between 0 and 1
             * @returns {number}
             */
            progress: function () {
    ...
    .controller('scrollCtrl', ["$scope", "$log", "$window", "$document", "scrollService", function ($scope, $log, $window, $document, scrollService) {
